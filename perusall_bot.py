...
read_speed = 0                     # adjust this number to read faster or slower
###########################
...
taskbar_location = pyautogui.locateOnScreen('Resources//task_bar.png', confidence=0.85)
comment_location = pyautogui.locateOnScreen('Resources//comment_section.png', confidence=0.85)
perusall_big_location = pyautogui.locateOnScreen('Resources//perusall_big.png', confidence=0.85)
side_bar_location = pyautogui.locateOnScreen('Resources//side_bar.png', confidence=0.85)
conv_location = pyautogui.locateOnScreen('Resources//conv.png')
next_x = 0
next_y = 0
...
def find_first_conv():
    ...
    while pyautogui.locateOnScreen('Resources//next.png', region=(comment_location)) is None:
        pyautogui.move(0, 10)
        pyautogui.click()
    pyautogui.click()
    global next_x, next_y
    next_pos = pyautogui.locateCenterOnScreen('Resources//next.png', region=(comment_location))
    next_x = next_pos.x
    next_y = next_pos.y
...
def like_in_conv():
    green_likes = pyautogui.locateAllOnScreen('Resources//green_like.png', region=(comment_location))
    if green_likes != None:
    ...
    likes = pyautogui.locateAllOnScreen('Resources//like.png', region=(comment_location))
    if likes != None:
        for pos in likes:
            if retina_display: 
                pyautogui.click(pos.left / 2, pos.top / 2)
                ...
                pyautogui.click(pos.left, pos.top)
    questions = pyautogui.locateAllOnScreen('Resources//question.png', region=(comment_location))
    if questions != None:
...
def summarize():
    ...
    summary_location = pyautogui.locateCenterOnScreen('Resources//summary.png', region=(taskbar_location))
    if retina_display:
        pyautogui.click(summary_location.x / 2, summary_location.y / 2)
        paste_location = pyautogui.locateCenterOnScreen('Resources//summary_paste.png')
        ...
        if(pyautogui.locateCenterOnScreen('Resources//summary_paste.png') != None):
            pyautogui.click('Resources/summary_paste.png')
    process = text.replace("\n", " ")
    pyautogui.write(process)

    summarize_location = pyautogui.locateCenterOnScreen('Resources//summarize.png')
    if retina_display:
        pyautogui.click(summarize_location.x / 2, summarize_location.y / 2 )
        time.sleep(5)
        copy_location = pyautogui.locateCenterOnScreen('Resources//copy.png')
        ...
        perusall_location = pyautogui.locateCenterOnScreen('Resources//Perusall.png')
        pyautogui.click(perusall_location.x / 2, perusall_location.y / 2)
        
    else:
        pyautogui.click(summarize_location.x, summarize_location.y)
        time.sleep(2)
        pyautogui.click('Resources//copy.png')
        
        pyautogui.click(screenWidth / 3, screenHeight / 2)
        pyautogui.hotkey('ctrl', 'a')
        pyautogui.press('backspace')
        
        pyautogui.click('Resources//Perusall.png')
...
def write_summary(sum_str):
    if retina_display:
        pyautogui.moveTo((comment_location[0] + comment_location[2] / 2) / 2, (comment_location[1] + comment_location[3]) / 2)
        pyautogui.scroll(-100 * 100)
        time.sleep(2)
        comment_box = pyautogui.locateCenterOnScreen('Resources//comment.png', region= comment_location)
        ...
        pyautogui.scroll(-100 * 100)
        time.sleep(2)
        pyautogui.click('Resources//comment.png')
    pyautogui.click()
